"""
Load initial data
Based on: https://stackoverflow.com/a/39743581
"""
...
def load_fixture(apps, schema_editor):
    ...
    # However, here it has a different context: the apps variable.
    ...
    try:
        ...
        call_command('loaddata', 'initial_data.json', app_label='superrentals')
    finally:
